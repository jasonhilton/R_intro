...
Therefore, we need to load in data on population. As above, read in the data on population and covert to tidy format, and store in dataframe called `pop_tidy_df`.
...
The relationship between gdpPercap and lifeExp looks highly non-linear. Perhaps a transformation would help address this.
...
### Question 5
**Label your plots with titles and more appropriate axis names.**
